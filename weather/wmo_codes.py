# Adapted from github:stellasphere/descriptions.json
WMO_MAP = {
    0: {"description": "Clear", "icon": "01"},
    1: {"description": "Mainly Clear", "icon": "01"},
    2: {"description": "Partly Cloudy", "icon": "02"},
    3: {"description": "Cloudy", "icon": "03"},
    45: {"description": "Foggy", "icon": "50"},
    ...
    66: {"description": "Light Freezing Rain", "icon": "10"},
    67: {"description": "Freezing Rain", "icon": "10"},
    ...
    80: {"description": "Light Showers", "icon": "09"},
    81: {"description": "Showers", "icon": "09"},
    82: {"description": "Heavy Showers", "icon": "09"},
    85: {"description": "Light Snow Showers", "icon": "13"},
    86: {"description": "Snow Showers", "icon": "13"},
    95: {"description": "Thunderstorm", "icon": "11"},
    96: {"description": "Light Thunderstorms With Hail", "icon": "11"},
    99: {"description": "Thunderstorm With Hail", "icon": "11"},
}
